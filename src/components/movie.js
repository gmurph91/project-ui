    ...
    render(){
        return (
                <div className="movie">
                    ...
                    <img className="updateIcon" src="edit.png" name={this.props.name} data-trailer={this.props.trailer} data-year={this.props.year} data-rating={this.props.rating} data-url={this.props.url} id={this.props.id} alt="update" onClick={this.props.update}/>
